...
@include('rkpd.program_rkpd');
@include('rkpd.indikator_program_rkpd');
@include('rkpd.urusan_program_rkpd');
@include('rkpd.pelaksana_program_rkpd');

@include('rkpd.cariIndikator');
@include('rkpd.cariProgramRPJMD');
@include('rkpd.cariRefUnit');
@include('rkpd.StatusProgram');

@endsection

@section('scripts')

@include('rkpd.js_rkpd')
@endsection
