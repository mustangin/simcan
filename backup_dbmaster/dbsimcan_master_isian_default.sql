...
-- Dumping database structure for dbsimcan_master
/* CREATE DATABASE IF NOT EXISTS `dbsimcan_master` !40100 DEFAULT CHARACTER SET latin1; */
/* USE `dbsimcan_master`; */

-- Dumping structure for table dbsimcan_master.ref_bidang
...
-- Dumping structure for table dbsimcan_master.ref_data_sub_unit
...
-- Dumping data for table dbsimcan_master.ref_data_sub_unit: ~0 rows (approximately)
DELETE FROM `ref_data_sub_unit`;
/*!40000 ALTER TABLE `ref_data_sub_unit` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_data_sub_unit` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_desa
...
-- Dumping data for table dbsimcan_master.ref_desa: ~10 rows (approximately)
DELETE FROM `ref_desa`;
...
-- Dumping structure for table dbsimcan_master.ref_dokumen
...
-- Dumping structure for table dbsimcan_master.ref_fungsi
...
-- Dumping structure for table dbsimcan_master.ref_group
...
-- Dumping structure for table dbsimcan_master.ref_indikator
CREATE TABLE IF NOT EXISTS `ref_indikator` (
  ...
  `jenis_indikator` int(11) NOT NULL COMMENT '1 positif 0 negatif',
  `sifat_indikator` int(11) NOT NULL COMMENT '1 Incremental 2 Absolut  3 Komulatif',
  `nm_indikator` varchar(255) DEFAULT NULL,
  `flag_iku` int(11) DEFAULT '0' COMMENT '0 non iku 1 iku pemda 2 iku skpd',
  ...
  KEY `jenis_indikator` (`jenis_indikator`,`sifat_indikator`,`flag_iku`,`asal_indikator`,`sumber_data_indikator`) USING BTREE,
  FULLTEXT KEY `nm_indikator` (`nm_indikator`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

-- Dumping data for table dbsimcan_master.ref_indikator: ~40 rows (approximately)
DELETE FROM `ref_indikator`;
/*!40000 ALTER TABLE `ref_indikator` DISABLE KEYS */;
INSERT INTO `ref_indikator` (`id_indikator`, `type_indikator`, `jenis_indikator`, `sifat_indikator`, `nm_indikator`, `flag_iku`, `asal_indikator`, `sumber_data_indikator`, `id_satuan_output`) VALUES
	(1, 0, 1, 0, 'Indeks Kepuasan Masyarakat', 0, 0, '-', 26),
	(2, 0, 1, 0, 'Indikator Pertanian', 0, 0, '-', 14),
	(3, 0, 1, 0, 'Kontribusi sektor pariwisata terhadap PDRB', 0, 0, '-', 26),
	(4, 0, 1, 0, 'Luas irigasi dalam kondisi baik', 0, 0, '-', 12),
	(5, 0, 1, 0, 'Panjang jalan dengan kondisi baik', 0, 0, '-', 9),
	(6, 0, 1, 0, 'Pemukiman dengan parasarana drainase dan jalan yang memadai', 0, 0, '-', 12),
	(7, 0, 1, 0, 'Pencapaian penerimaan PAD sesuai target', 0, 0, '-', 19),
	(8, 0, 1, 0, 'Rumah tangga pengguna air bersih', 0, 0, '-', 1),
	(9, 0, 1, 0, 'Tercatatnya aset milik daerah', 0, 0, '-', 19),
	(10, 0, 1, 0, '-', 0, 1, '-', 26),
	(11, 0, 1, 0, 'Capaian pelayanan kebutuhan administrasi kantor', 0, 1, '-', 26),
	(12, 0, 1, 0, 'Kinerja Sistem Irigasi Pada DI Kewenangan Kabupaten Dalam Kondisi Baik', 0, 1, '-', NULL),
	(13, 0, 1, 0, 'Peningkatan kunjungan wisatwan', 0, 1, '-', NULL),
	(14, 0, 1, 0, 'Peningkatan lama waktu tinggal wisatwan', 0, 1, '-', NULL),
	(15, 0, 1, 0, 'Perdesaan dengan parasarana jalan yang memadai', 0, 1, '-', NULL),
	(16, 0, 1, 0, 'Permukiman dengan parasarana drainase yang memadai', 0, 1, '-', NULL),
	(17, 0, 1, 0, 'Permukiman dengan parasarana jalan yang memadai', 0, 1, '-', NULL),
	(18, 0, 1, 0, 'Persentase jalan dan jembatan dalam kondisi baik', 0, 1, '-', NULL),
	(19, 0, 1, 0, 'Persentase peningkatan kapasitas jalan dan jembatan', 0, 1, '-', NULL),
	(20, 0, 1, 0, 'Tertib Pengelolaan Keuangan Daerah', 0, 1, '-', NULL),
	(21, 0, 1, 0, 'Tertib Pengelolaan Keuangan Desa', 0, 1, '-', NULL),
	(22, 0, 1, 1, '-', 0, 1, '-', NULL),
	(23, 0, 1, 2, 'Aplikasi Pencatatan Pendapatan', 0, 1, '-', NULL),
	(24, 0, 1, 2, 'Dokumen Sisdur Pengelolaan Keuangan Daerah', 0, 1, '-', NULL),
	(25, 0, 1, 2, 'Jalan paving pedesaan yang dibangun', 0, 1, '-', NULL),
	(26, 0, 1, 2, 'Jaringan air bersih yang dibangun', 0, 1, '-', NULL),
	(27, 0, 1, 2, 'Jembatan terbangun', 0, 1, '-', NULL),
	(28, 0, 1, 2, 'Jembatan yang direhab', 0, 1, '-', NULL),
	(29, 0, 1, 2, 'Kelompok usaha terkait pariwisata yang dibina', 0, 1, '-', NULL),
	(30, 0, 1, 2, 'Panjang jalan dipelihara', 0, 1, '-', NULL),
	(31, 0, 1, 2, 'Panjang jalan permukiman yang dibangun ', 0, 1, '-', NULL),
	(32, 0, 1, 2, 'Panjang Saluran yang Dibangun', 0, 1, '-', NULL),
	(33, 0, 1, 2, 'Pedoman pengelolaan keuangan desa', 0, 1, '-', NULL),
	(34, 0, 1, 2, 'Pemandu wisata yang dilatih', 0, 1, '-', NULL),
	(35, 0, 1, 2, 'Pemenuhan kebutuhan ATK', 0, 1, '-', NULL),
	(36, 0, 1, 2, 'Peningkatan pengetahuan bendahara penerimaan dan bendahara pengeluaran', 0, 1, '-', NULL),
	(37, 0, 1, 2, 'Perjalanan Dinas luar daerah', 0, 1, '-', NULL),
	(38, 0, 1, 3, 'Panjang jalan terbangun', 0, 1, '-', NULL),
	(39, 2, 1, 1, 'Indikator Pendapatan Pemda', 0, 9, 'Indikator Program Pendapatan Pemda', NULL),
	(40, 2, 1, 1, 'Indikator Belanja Tidak Langsung', 0, 9, 'Indikator Belanja Tidak Langsung Pemda', NULL);
/*!40000 ALTER TABLE `ref_indikator` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_jadwal
...
-- Dumping structure for table dbsimcan_master.ref_jenis_lokasi
...
-- Dumping structure for table dbsimcan_master.ref_kabupaten
...
-- Dumping structure for table dbsimcan_master.ref_kecamatan
...
-- Dumping structure for table dbsimcan_master.ref_kegiatan
...
) ENGINE=InnoDB AUTO_INCREMENT=3982 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
-- Dumping structure for table dbsimcan_master.ref_kolom_tabel_dasar
...
-- Dumping structure for table dbsimcan_master.ref_langkah
...
-- Dumping structure for table dbsimcan_master.ref_log_akses
...
INSERT INTO `ref_log_akses` (`id_log`, `fl1`, `fd1`, `fp2`, `fu3`, `fr4`) VALUES
	('T1BtU3YzUVpkSms0MkRTOUlCVUhnZz09', '2018-07-31 12:19:32', 'KABUPATEN PURWOREJO', '2018-07-31 12:19:32', '2018-07-31 12:19:32', '2018-07-31 12:19:32'),
...
-- Dumping structure for table dbsimcan_master.ref_lokasi
...
-- Dumping structure for table dbsimcan_master.ref_mapping_asb_renstra
...
-- Dumping data for table dbsimcan_master.ref_mapping_asb_renstra: ~0 rows (approximately)
DELETE FROM `ref_mapping_asb_renstra`;
/*!40000 ALTER TABLE `ref_mapping_asb_renstra` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_mapping_asb_renstra` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_menu
...
-- Dumping structure for table dbsimcan_master.ref_pemda
...
-- Dumping structure for table dbsimcan_master.ref_pengusul
...
-- Dumping structure for table dbsimcan_master.ref_prioritas_nasional
...
-- Dumping structure for table dbsimcan_master.ref_prioritas_provinsi
...
-- Dumping data for table dbsimcan_master.ref_prioritas_provinsi: ~0 rows (approximately)
DELETE FROM `ref_prioritas_provinsi`;
/*!40000 ALTER TABLE `ref_prioritas_provinsi` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_prioritas_provinsi` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_program
...
) ENGINE=InnoDB AUTO_INCREMENT=484 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
-- Dumping structure for table dbsimcan_master.ref_program_nasional
...
-- Dumping structure for table dbsimcan_master.ref_program_provinsi
...
-- Dumping data for table dbsimcan_master.ref_program_provinsi: ~0 rows (approximately)
DELETE FROM `ref_program_provinsi`;
/*!40000 ALTER TABLE `ref_program_provinsi` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_program_provinsi` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_rek_1
...
-- Dumping structure for table dbsimcan_master.ref_rek_2
CREATE TABLE IF NOT EXISTS `ref_rek_2` (
  ...
  UNIQUE KEY `kd_rek_1` (`kd_rek_1`,`kd_rek_2`),
...
-- Dumping structure for table dbsimcan_master.ref_rek_3
CREATE TABLE IF NOT EXISTS `ref_rek_3` (
  ...
  KEY `kd_rek_1` (`kd_rek_1`,`kd_rek_2`,`kd_rek_3`),
...
-- Dumping structure for table dbsimcan_master.ref_rek_4
CREATE TABLE IF NOT EXISTS `ref_rek_4` (
  ...
  UNIQUE KEY `kd_rek_1` (`kd_rek_1`,`kd_rek_2`,`kd_rek_3`,`kd_rek_4`),
...
-- Dumping structure for table dbsimcan_master.ref_rek_5
...
) ENGINE=InnoDB AUTO_INCREMENT=1581 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
-- Dumping structure for table dbsimcan_master.ref_revisi
...
-- Dumping data for table dbsimcan_master.ref_revisi: ~0 rows (approximately)
DELETE FROM `ref_revisi`;
/*!40000 ALTER TABLE `ref_revisi` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_revisi` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_satuan
...
-- Dumping structure for table dbsimcan_master.ref_setting
...
-- Dumping structure for table dbsimcan_master.ref_ssh_zona
...
-- Dumping structure for table dbsimcan_master.ref_ssh_zona_lokasi
...
-- Dumping data for table dbsimcan_master.ref_ssh_zona_lokasi: ~0 rows (approximately)
DELETE FROM `ref_ssh_zona_lokasi`;
/*!40000 ALTER TABLE `ref_ssh_zona_lokasi` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_ssh_zona_lokasi` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_status_usul
...
-- Dumping data for table dbsimcan_master.ref_status_usul: ~0 rows (approximately)
DELETE FROM `ref_status_usul`;
/*!40000 ALTER TABLE `ref_status_usul` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_status_usul` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.ref_sub_unit
...
-- Dumping structure for table dbsimcan_master.ref_sumber_dana
...
-- Dumping structure for table dbsimcan_master.ref_tabel_dasar
...
-- Dumping structure for table dbsimcan_master.ref_tahun
...
-- Dumping structure for table dbsimcan_master.ref_unit
...
-- Dumping structure for table dbsimcan_master.ref_urusan
...
-- Dumping structure for table dbsimcan_master.ref_user_role
...
-- Dumping structure for table dbsimcan_master.trx_group_menu
...
-- Dumping data for table dbsimcan_master.trx_group_menu: ~0 rows (approximately)
DELETE FROM `trx_group_menu`;
/*!40000 ALTER TABLE `trx_group_menu` DISABLE KEYS */;
/*!40000 ALTER TABLE `trx_group_menu` ENABLE KEYS */;

-- Dumping structure for table dbsimcan_master.users
